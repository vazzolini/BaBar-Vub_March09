// $Id: PidCorrectMesMean.cc,v 1.3 2008/02/14 18:22:01 sacco Exp $
//
...
// The mES correction is not implemented for MC
  ...
  _maxRunNumber += 100; // a grace period
  (*mapMesMeans)[_maxRunNumber]=(*(--mapMesMeans->lower_bound(_maxRunNumber-100))).second;
  ++(mapMesMeans->lower_bound(_maxRunNumber-100));
